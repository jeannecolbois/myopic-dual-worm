...
void mcsevolve(double J1, std::vector<std::tuple<double, int*, int, int>> interactions, int* states, int state_size, int* d_nd, int n_nd, int* d_vd, int n_vd, int* d_wn, double *betas, double *energies, int nbt, int nmaxiter, int niterworm, int nthreads) {
